/* lxcfs
 *
 * Copyright 漏 2014-2016 Canonical, Inc
...
lt-lxcfs on /usr/local/var/lib/lxcfs type fuse.lt-lxcfs (rw,nosuid,nodev,relatime,user_id=0,group_id=0,allow_other)
*/  //mount cgroup
...
//mount /proc/self/cgroup相关的cgroup到/run/lxcfs/controllers
...
net_prio,net_cls on /run/lxcfs/controllers/net_prio,net_cls type cgroup (rw,relatime,net_prio,net_cls)
name=systemd on /run/lxcfs/controllers/name=systemd type cgroup (rw,relatime,xattr,release_agent=/usr/lib/systemd/systemd-cgroups-agent,name=systemd)
/root/git/reading-and-annotate-lxc-1.0.9/lxcfs-lxcfs-2.0.0/lxcfs on /usr/local/var/lib/lxcfs type fuse.lxcfs (rw,nosuid,nodev,relatime,user_id=0,group_id=0,allow_other)
